"""
    contains an amino acid dictionary, formatting parameters, 
    and helper functions used in both uniprot_seqres.py and pdb_seqres.py    
"""

d = {'G': 'GLY', 'A': 'ALA', 'V': 'VAL', 'L': 'LEU', 'I': 'ILE',
     'T': 'THR', 'S': 'SER', 'M': 'MET', 'C': 'CYS', 'P': 'PRO',
     'F': 'PHE', 'Y': 'TYR', 'W': 'TRP', 'H': 'HIS', 'K': 'LYS',
     'R': 'ARG', 'D': 'ASP', 'E': 'GLU', 'N': 'ASN', 'Q': 'GLN'}

NUM_OF_AMINO_ACIDS_PER_LINE = 13
PROGRAM_CODE = 'SEQRES'


def splitter(alist, k):
...
def formatter(program_code, line_num, chain_num, length, sequence):
